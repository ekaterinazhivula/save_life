...
const editPetItem = async () => {
    new HystModal({
        ...
        beforeOpen: async (modal) => {
            ...
            modalContainer.innerHTML = `
                <form id="updatePetForm" class="update-form" >
                    ...
                    <div class="update-form__buttons-container">
                        <button class="update-form__save-button" id="savePet" data-hystclose data-petId="${pet.id}">
            ...
            modalContainer.querySelector("#savePet").addEventListener("click", async (event) => {
